...
export const CATEGORY = [
  { id: 0, text: "사이트소개", name: "islubean" },
  { id: 1, text: "원두", name: "products" },
  { id: 2, text: "굿즈", name: "goods" },
  { id: 3, text: "매장", name: "store" },
  { id: 4, text: "이벤트", name: "event" },
];
...
export const PRODUCTS_SUBMENU = [
  {
    ...
    subMenu: [
      ...
      { id: 7, country: "id값", text: "콜롬비아" },
      { id: 7, country: "id값", text: "탄자니아" },
      { id: 7, country: "id값", text: "파나마" },
      { id: 7, country: "id값", text: "파푸아뉴기니" },
    ],
  },
